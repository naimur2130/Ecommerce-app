      ...
      <div>
        ...
        <div className="flex gap-2">
          <label htmlFor="image1">
            <img
              className="w-20"
              src={!image1 ? assets.upload_image : URL.createObjectURL(image1)}
              alt=""
            />
            <input
          ...
          <label htmlFor="image2">
            <img
              className="w-20"
              src={!image2 ? assets.upload_image : URL.createObjectURL(image2)}
              alt=""
            />
            <input
          ...
          <label htmlFor="image3">
            <img
              className="w-20"
              src={!image3 ? assets.upload_image : URL.createObjectURL(image3)}
              alt=""
            />
            <input
          ...
          <label htmlFor="image4">
            <img
              className="w-20"
              src={!image4 ? assets.upload_image : URL.createObjectURL(image4)}
              alt=""
            />
            <input
